...
def serve_alpine():
    try:
        alpine_file = Path(__file__).parent / "alpine.js"
        if alpine_file.exists():
            return alpine_file.read_text()
        return "console.error('Alpine.js not found')"
    except:
        return "console.error('Error loading Alpine.js')"
